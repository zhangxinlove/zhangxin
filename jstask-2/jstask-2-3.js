// 取出数组
var identifyIfo = JSON.parse(sessionStorage.getItem("identify"));
var num = sessionStorage.getItem("playerNums");
var words1 = sessionStorage.getItem("words1");
var words2 = sessionStorage.getItem("words2");
...
// 返回上一页
function backOne() {
    window.location.href = "jstask-2-2.html";
}
// bc是号码
var a = 0;
var b = 1;
...
// 获取要操作元素的所以dom节点
var cardIcon = document.getElementsByClassName("boxthree");
var roleCardIcon = document.getElementsByClassName("boxfour");
...
num1.innerHTML = b;
num1.style.cssText = "margin-top:5px;vertical-align:middle;color:#f56b81;";
...
function nextPage() {
    window.location.href = "jstask-2-4.html";
}

function checkedWords() {
    if (identifyIfo[a] == "杀手") {
        wordsInfo.innerHTML = words1;
    } else {
        wordsInfo.innerHTML = words2
    }
}